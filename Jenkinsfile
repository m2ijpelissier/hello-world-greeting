pipeline { 
  ...
  stages {
    ...
    stage('Publication') {
      steps {
        sh 'echo " hello world "'
        sh "curl -u admin:admin --upload-file /home/jenkins/workspace/hello_world_master/target/hello-0.0.1.war 'http://10.10.20.31:8081/repository/depot_test/hello-0.0.1.war'"
